...
function App() {
  ...
  return (
    <div className="App">
      <div className="title">LET'S BUILD A HUMAN BRO</div>
      <div className="exit">
      <a href="https://mainmenuakinator.netlify.app">Exit</a>
      </div>
      ...
      <div>
          <div className="avatar-wrapper">
            ...
            <div className="text-center">
							<button className="button btn-reset" onClick={() => setToDefault()}>
								Reset
							</button>
							<button className="button btn-reset" onClick={() => randomAvatar()}>
								Random
							</button>
						</div>
          </div>
